...
part of 'dinhgianhanh_chcc_list_item_controller.dart';

// **************************************************************************
// RiverpodGenerator
// **************************************************************************

String _$getListAssetsHash() => r'60d830bd1b9c6a7e929817119067c026f9af5a14';
...
class _GetListAssetsFamily
    extends Family<AsyncValue<ApiResponse<List<CHCCFastValModel>?>>> {
  /// See also [_getListAssets].
...
class _GetListAssetsProvider
    extends AutoDisposeFutureProvider<ApiResponse<List<CHCCFastValModel>?>> {
  /// See also [_getListAssets].
  ...
  Override overrideWith(
    FutureOr<ApiResponse<List<CHCCFastValModel>?>> Function(
  ...
  @override
  AutoDisposeFutureProviderElement<ApiResponse<List<CHCCFastValModel>?>>
      createElement() {
...
mixin _GetListAssetsRef
    on AutoDisposeFutureProviderRef<ApiResponse<List<CHCCFastValModel>?>> {
...
class _GetListAssetsProviderElement extends AutoDisposeFutureProviderElement<
    ApiResponse<List<CHCCFastValModel>?>> with _GetListAssetsRef {
