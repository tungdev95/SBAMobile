...
class KetQuaChiTietCTXD extends ConsumerWidget {
  final List<InputFieldModel> lsItem;

  const KetQuaChiTietCTXD({
    super.key,
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    return BaseBottomSheetBodyWidget(
      title: S.current.ket_qua_chi_tiet_gia_ctxd,
      children: [
        const SizedBox(
          height: 8,
        ),
