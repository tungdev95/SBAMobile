...
PTDTModel _$PTDTModelFromJson(Map<String, dynamic> json) => PTDTModel(
      ...
      legalCountryMfg: (json['legalCountryMfg'] as num?)?.toInt(),
      legalShipbuildingBrand: json['legalShipbuildingBrand'] as String?,
      legalRegisterCountry: (json['legalRegisterCountry'] as num?)?.toInt(),
      ...
      legalMachineNum: (json['legalMachineNum'] as num?)?.toInt(),
      ...
      realCountryMfg: (json['realCountryMfg'] as num?)?.toInt(),
      realShipbuildingBrand: json['realShipbuildingBrand'] as String?,
      realRegisterCountry: (json['realRegisterCountry'] as num?)?.toInt(),
      ...
      realMachineNum: (json['realMachineNum'] as num?)?.toInt(),
      ...
      realYearReconstructed: (json['realYearReconstructed'] as num?)?.toInt(),
      legalYearReconstructed: (json['legalYearReconstructed'] as num?)?.toInt(),
      ...
      numberOfDaysUsed: (json['numberOfDaysUsed'] as num?)?.toInt(),
