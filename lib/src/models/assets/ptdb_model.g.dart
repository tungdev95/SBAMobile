...
PTDBModel _$PTDBModelFromJson(Map<String, dynamic> json) => PTDBModel(
      ...
      legalGearBoxId: (json['legalGearBoxId'] as num?)?.toInt(),
      legalWheelFormulaId: (json['legalWheelFormulaId'] as num?)?.toInt(),
      legalFuelId: (json['legalFuelId'] as num?)?.toInt(),
      ...
      realGearBoxId: (json['realGearBoxId'] as num?)?.toInt(),
      realWheelFormulaId: (json['realWheelFormulaId'] as num?)?.toInt(),
      realFuelId: (json['realFuelId'] as num?)?.toInt(),
