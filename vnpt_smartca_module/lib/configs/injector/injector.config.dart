...
import '../../data/network/eseal/3rd_eseal_api.dart' as _i66;
import '../../data/network/eseal/api_gateway_eseal.dart' as _i62;
import '../../data/network/eseal/auth_api_eseal.dart' as _i63;
import '../../data/network/eseal/cert_api_eseal.dart' as _i64;
import '../../data/network/eseal/transaction_api_eseal.dart' as _i68;
import '../../data/network/forgot_password.dart' as _i42;
import '../../data/network/order_cert_api.dart' as _i46;
import '../../data/network/otp_verify_api.dart' as _i44;
import '../../data/network/policy_data_api.dart' as _i48;
import '../../data/network/purchase_certificate_api.dart' as _i50;
import '../../data/network/send_log_api.dart' as _i52;
import '../../data/network/service_pack_api.dart' as _i54;
import '../../data/network/service_pack_history_api.dart' as _i55;
import '../../data/network/sign_bill_api.dart' as _i58;
...
import '../../data/repository/active_account_repository.dart' as _i61;
...
import '../../data/repository/eseal/3rd_repository.dart' as _i67;
import '../../data/repository/eseal/certificate_repository.dart' as _i65;
import '../../data/repository/eseal/transaction_repository.dart' as _i69;
import '../../data/repository/forgot_password.dart' as _i43;
import '../../data/repository/order_cert_repository.dart' as _i47;
import '../../data/repository/otp_verify_repository.dart' as _i45;
import '../../data/repository/policy_data_repository.dart' as _i49;
import '../../data/repository/purchase_certificate_repository.dart' as _i51;
import '../../data/repository/send_log_repository.dart' as _i53;
import '../../data/repository/service_pack_history_respository.dart' as _i56;
import '../../data/repository/service_pack_page_respository.dart' as _i57;
import '../../data/repository/sign_bill_repository.dart' as _i59;
...
import '../../data/repository/user_repository.dart' as _i60;
...
import '../register_module.dart' as _i70;
...
_i1.GetIt $initGetIt(
  ...
  gh.factory<_i42.ForgotPasswordApi>(() => registerModule.forgotPasswordApi);
  gh.factory<_i43.ForgotPasswordRepository>(
      () => registerModule.forgotPasswordRepository);
  gh.factory<_i44.OTPVerifyApi>(
      () => _i44.OTPVerifyApi(gh<_i20.SmartCAApiGateway<dynamic>>()));
  gh.factory<_i45.OTPVerifyRepository>(
      () => registerModule.otpVerifyRepository);
  gh.factory<_i46.OrderCertApi>(
      () => _i46.OrderCertApi(gh<_i20.SmartCAApiGateway<dynamic>>()));
  gh.factory<_i47.OrderCertRepository>(
      () => registerModule.orderCertRepository);
  gh.factory<_i48.PolicyDataApi>(
      () => _i48.PolicyDataApi(gh<_i20.SmartCAApiGateway<dynamic>>()));
  gh.factory<_i49.PolicyDataRepository>(
      () => registerModule.policyDataRepository);
  gh.factory<_i50.PurchaseCertificateApi>(
      () => _i50.PurchaseCertificateApi(gh<_i20.SmartCAApiGateway<dynamic>>()));
  gh.factory<_i51.PurchaseCertificateRepository>(
      () => registerModule.purchaseCertificateRepository);
  gh.lazySingleton<_i52.SendLogAPI>(() => registerModule.sendLogAPI);
  gh.lazySingleton<_i53.SendLogRepository>(
      () => registerModule.sendLogRepository);
  gh.factory<_i54.ServicePackApi>(
      () => _i54.ServicePackApi(gh<_i20.SmartCAApiGateway<dynamic>>()));
  gh.factory<_i55.ServicePackHistoryApi>(
      () => _i55.ServicePackHistoryApi(gh<_i20.SmartCAApiGateway<dynamic>>()));
  gh.factory<_i56.ServicePackHistoryRepository>(
      () => registerModule.servicePackHistoryRepository);
  gh.factory<_i57.ServicePackRepository>(
      () => registerModule.servicePackRepository);
  gh.factory<_i58.SignBillApi>(
      () => _i58.SignBillApi(gh<_i20.SmartCAApiGateway<dynamic>>()));
  gh.factory<_i59.SignBillRepository>(() => registerModule.signBillRepository);
  gh.factory<_i60.UserRepository>(() => registerModule.userRepository);
  gh.factory<_i61.ActiveAccountRepository>(
      () => registerModule.activeAccountRepository);
  gh.factory<_i62.ApiGatewayEseal<dynamic>>(
      () => registerModule.apiGatewayEseal);
  gh.factory<_i63.AuthApiEseal>(
      () => _i63.AuthApiEseal(gh<_i62.ApiGatewayEseal<dynamic>>()));
  gh.factory<_i64.CertApiEseal>(
      () => _i64.CertApiEseal(gh<_i62.ApiGatewayEseal<dynamic>>()));
  gh.factory<_i65.CertificateRepositoryEseal>(
      () => registerModule.certificateRepositoryEseal);
  gh.factory<_i66.ThirdPartyApiEseal>(
      () => _i66.ThirdPartyApiEseal(gh<_i62.ApiGatewayEseal<dynamic>>()));
  gh.factory<_i67.ThirdPartyRepositoryEseal>(
      () => registerModule.thirdPartyRepositoryEseal);
  gh.factory<_i68.TransactionEsealApi>(() => _i68.TransactionEsealApi(
        gh<_i62.ApiGatewayEseal<dynamic>>(),
        gh<_i40.EsealApiConfig>(),
      ));
  gh.factory<_i69.TransactionRepositoryEseal>(
...
class _$RegisterModule extends _i70.RegisterModule {
  ...
  @override
  _i42.ForgotPasswordApi get forgotPasswordApi =>
      _i42.ForgotPasswordApi(_getIt<_i20.SmartCAApiGateway<dynamic>>());

  @override
  _i43.ForgotPasswordRepository get forgotPasswordRepository =>
      _i43.ForgotPasswordRepository(_getIt<_i42.ForgotPasswordApi>());

  @override
  _i45.OTPVerifyRepository get otpVerifyRepository =>
      _i45.OTPVerifyRepository(_getIt<_i44.OTPVerifyApi>());

  @override
  _i47.OrderCertRepository get orderCertRepository =>
      _i47.OrderCertRepository(_getIt<_i46.OrderCertApi>());

  @override
  _i49.PolicyDataRepository get policyDataRepository =>
      _i49.PolicyDataRepository(_getIt<_i48.PolicyDataApi>());

  @override
  _i51.PurchaseCertificateRepository get purchaseCertificateRepository =>
      _i51.PurchaseCertificateRepository(_getIt<_i50.PurchaseCertificateApi>());

  @override
  _i52.SendLogAPI get sendLogAPI =>
      _i52.SendLogAPI(_getIt<_i20.SmartCAApiGateway<dynamic>>());

  @override
  _i53.SendLogRepository get sendLogRepository => _i53.SendLogRepository(
        _getIt<_i52.SendLogAPI>(),
        _getIt<_i17.SecureLocalStorageService>(),
        _getIt<_i6.DeviceInfoService>(),
      );

  @override
  _i56.ServicePackHistoryRepository get servicePackHistoryRepository =>
      _i56.ServicePackHistoryRepository(_getIt<_i55.ServicePackHistoryApi>());

  @override
  _i57.ServicePackRepository get servicePackRepository =>
      _i57.ServicePackRepository(_getIt<_i54.ServicePackApi>());

  @override
  _i59.SignBillRepository get signBillRepository =>
      _i59.SignBillRepository(_getIt<_i58.SignBillApi>());

  @override
  _i60.UserRepository get userRepository => _i60.UserRepository(
        _getIt<_i29.AuthRemoteApi>(),
        _getIt<_i17.SecureLocalStorageService>(),
      );

  @override
  _i61.ActiveAccountRepository get activeAccountRepository =>
      _i61.ActiveAccountRepository(
        _getIt<_i29.AuthRemoteApi>(),
        _getIt<_i18.SmartCAApiConfig>(),
  ...
  @override
  _i62.ApiGatewayEseal<dynamic> get apiGatewayEseal =>
      _i62.ApiGatewayEseal<dynamic>(
  ...
  @override
  _i65.CertificateRepositoryEseal get certificateRepositoryEseal =>
      _i65.CertificateRepositoryEseal(_getIt<_i64.CertApiEseal>());

  @override
  _i67.ThirdPartyRepositoryEseal get thirdPartyRepositoryEseal =>
      _i67.ThirdPartyRepositoryEseal(_getIt<_i66.ThirdPartyApiEseal>());

  @override
  _i69.TransactionRepositoryEseal get transactionRepositoryEseal =>
      _i69.TransactionRepositoryEseal(_getIt<_i68.TransactionEsealApi>());
}
