...
class PurchaseCertificateApi {
  ...
  Future<SmartCAApiResponse> initPersonalCertificateOrderTransaction(
    ...
    final url =
        '/${AppConfig.language}/order/PersonalCertificateOrder/initPersonalCertificateOrderTransaction';
  ...
  Future<SmartCAApiResponse> initPersonalCertificateOrderTransactionV2(
    ...
    final url = '/${AppConfig.language}/order/CertOrderCompleteOnline/initCertOrderPayment';
  ...
  Future<SmartCAApiResponse> checkOrderPaymentResult(
      ...
      String responseCode,
      String secureCode,
      String localityCode) async {
    final url =
        '/${AppConfig.language}/order/payment/checkOrderPaymentResultAnonymous';
    final result = await _httpClientService.post(url, {
      "id": id,
  ...
  getAllWards() async {
    final url = '/${AppConfig.language}/thirdpartyapi/category/getAllWards';
    final result = await _httpClientService.post(url, {});
    return SmartCAApiResponse.fromMap(result);
  }
}
