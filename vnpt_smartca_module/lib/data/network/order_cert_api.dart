...
class OrderCertApi {
  ...
  Future<SmartCAApiResponse> createPersonalCertificateOrder(
    ...
    final url = '/${AppConfig.language}/order/CertOrderCompleteOnline/create_cert_new_order';
  ...
  Future<SmartCAApiResponse> getOrderInfo(dynamic dataItems) async {
    // final url = '/${AppConfig.language}/order/PersonalCertificateOrder/createPersonalCertificateOrder';
    final url = '/${AppConfig.language}/order/certorderCompleteOnline/cert_order_info';
  ...
  Future<SmartCAApiResponse> getOrderOTP(dynamic dataItems) async {
    ...
    final url = '/verify/otp/send_otp';
    final result = await _httpClientService.post(url, dataItems);
    return SmartCAApiResponse.fromMap(result);
  }

  Future<SmartCAApiResponse> verifyOTPAndActiveKeyPair(
  ...
  Future<SmartCAApiResponse> verifyEkycWithOrderId(dynamic dataItems) async {
    // final url = '/${AppConfig.language}/order/PersonalCertificateOrder/createPersonalCertificateOrder';
    final url = '/${AppConfig.language}/order/certorderCompleteOnline/verifyEkycCertOrder';
  ...
  Future<SmartCAApiResponse> getListOrder() async {
    final result = await _httpClientService.post(
      '/${AppConfig.language}/order/certorderCompleteOnline/listCertOrder',
  ...
  Future<SmartCAApiResponse> getAllOrder() async {
    final result = await _httpClientService.post(
      '/${AppConfig.language}/order/certorderCompleteOnline/listCertOrder',
      // '/${AppConfig.language}/order/certorder/listCertOrder',
      {
  ...
  Future<SmartCAApiResponse> getUserAddress() async {
    final result = await _httpClientService
        .post('/${AppConfig.language}/order/certorderCompleteOnline/get_user_address', {});
        // .post('/${AppConfig.language}/order/certorder/get_user_address', {});
    return SmartCAApiResponse.fromMap(result);
  }

  Future<SmartCAApiResponse> updateUserAddress(UserAddress userAddress) async {
    final result = await _httpClientService
        .post('/${AppConfig.language}/identityapi/user/updateAddressV2', {
  ...
  Future<SmartCAApiResponse> updateOrderAddress(String orderId) async {
    final result = await _httpClientService
        .post('/${AppConfig.language}/order/certorderCompleteOnline/updateOrderAddress', {
        // .post('/${AppConfig.language}/order/certorder/updateOrderAddress', {
      "OrderId": orderId,
    });
    return SmartCAApiResponse.fromMap(result);
  }
  ...
  Future<SmartCAApiResponse> verifyEkyc(EkycCustomerRequest param) async {
    String path = '/${AppConfig.language}/verify/ekyc/ekyc_customer';

    final formData = FormData.fromMap({
      'Uid': param.uid,
      'FullName': param.fullName,
      'NearPortrait': Platform.isIOS
          ? MultipartFile.fromBytes(param.nearPortrait,
              filename: 'nearPortrait.jpg')
          : await MultipartFile.fromFile(param.nearPortrait,
              filename: 'nearPortrait.jpg'),
      'FarPortrait': Platform.isIOS
          ? MultipartFile.fromBytes(param.farPortrait,
              filename: 'farPortrait.jpg')
          : await MultipartFile.fromFile(param.farPortrait,
              filename: 'farPortrait.jpg'),
      'IdFront': Platform.isIOS
          ? MultipartFile.fromBytes(param.idFront, filename: 'idFront.jpg')
          : await MultipartFile.fromFile(param.idFront,
              filename: 'idFront.jpg'),
      'IdBack': Platform.isIOS
          ? MultipartFile.fromBytes(param.idBack, filename: 'idBack.jpg')
          : await MultipartFile.fromFile(param.idBack, filename: 'idBack.jpg'),
      'IdFrontFull': Platform.isIOS
          ? MultipartFile.fromBytes(param.idFrontFull,
              filename: 'idFrontFull.jpg')
          : await MultipartFile.fromFile(param.idFrontFull,
              filename: 'idFrontFull.jpg'),
      'IdBackFull': Platform.isIOS
          ? MultipartFile.fromBytes(param.idBackFull,
              filename: 'idBackFull.jpg')
          : await MultipartFile.fromFile(param.idBackFull,
              filename: 'idBackFull.jpg'),
    ...
    final result = await _httpClientService.post(
      path,
      formData,
      options: Options(headers: {"Content-Length": formData.length}),
    );
    return SmartCAApiResponse.fromMap(result);
  }

  Future<SmartCAApiResponse> createExtendOrder(
      String certSerial, String pricingCode) async {
    final result = await _httpClientService.post(
        '/${AppConfig.language}/order/CertOrderCompleteOnline/create_cert_extend_order',
        // '/${AppConfig.language}/order/CertOrder/create_cert_extend_order',
        {"serial": certSerial, "pricingCode": pricingCode});
    return SmartCAApiResponse.fromMap(result);
  }

  Future<SmartCAApiResponse> cancelOrder(String orderId) async {
    final result = await _httpClientService
        .post('/${AppConfig.language}/order/certorderCompleteOnline/cancel_order', {
        // .post('/${AppConfig.language}/order/certorder/cancel_order', {
      "orderId": orderId,
    });
    return SmartCAApiResponse.fromMap(result);
  }

  Future<SmartCAApiResponse> createChangeInfoOrder(
      String certSerial, String newName) async {
    final result = await _httpClientService.post(
        '/${AppConfig.language}/order/certorderCompleteOnline/create_cert_change_info_order',
        // '/${AppConfig.language}/order/certorder/create_cert_change_info_order',
        {"Serial": certSerial, "FullName": newName});
    return SmartCAApiResponse.fromMap(result);
  }

  Future<SmartCAApiResponse> getRefInfo(String value) async {
    final result = await _httpClientService.post(
      '${AppConfig.suggestedRefCodesUrl}/agent/ReferralCode/suggestedRefCodes',
      {"PageIndex": 1, "PageSize": 10, "searchText": value},
    );
    return SmartCAApiResponse.fromMap(result);
  }
}
