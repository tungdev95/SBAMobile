...
class _CertificateItemWidget extends StatelessWidget {
  ...
  _getExpiresDay() {
    ...
    try {
      ...
      String date =
          datetimeFormat.formatDate(certificateModel.validTo.toString());
      num = DatetimeFormat()
  ...
  Widget build(BuildContext context) {
    ...
    return InkWell(
      onTap: () async {
        ExtendCertificateController extendCertificateController = Get.find<ExtendCertificateController>();
                    ...
                    child: BaseText(
                      certificateModel.typeStatus == StatusCertEnum.EXPIRED
                          ...
                          : AppLocalizations.current
                              .expire_in_day(_getExpiresDay() ?? 0),
