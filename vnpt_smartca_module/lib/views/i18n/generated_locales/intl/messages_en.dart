...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m8(number) => "Expires at ${number}";

  static String m9(number) => "Expires in ${number} days";

  static String m10(number) => "${number} month";

  static String m11(anything) =>
      "If deleted, please make the link on the system \'${anything}\' to link again.";

  static String m12(anything) => "Please enter ${anything}";

  static String m13(numberPackages) => "List Packages (${numberPackages})";

  static String m14(anything) => "Please enter up to ${anything} characters";

  static String m15(anything) => "Please enter at least ${anything} characters";
  ...
  static String m18(step) => "Step ${step}";

  static String m19(action) =>
  ...
  static String m20(number) => "${number} incomplete operations";

  static String m21(number) =>
      "${number} incomplete Pending Contract operations";

  static String m22(number) => "${number} incomplete eKYC Pending operations";

  static String m23(number) =>
      "${number} incomplete Pending Payment operations";

  static String m24(number) => "${number} incomplete registration operations";

  static String m25(number) =>
      "${number} digital certificates awaiting activation!";

  static String m26(number) =>
      "There are ${number} orders waiting to be handle!";

  static String m27(any) =>
      "Password reset confirmation code has been sent to ${any}.";
  ...
  static String m32(purpose) => "Please use biometric to ${purpose}";

  static String m33(numberPackages) => "Result (${numberPackages})";

  static String m34(anything) => "Enter ${anything} to continue";

  static String m35(transactionCount, message) =>
      "Signed successfully ${transactionCount} transaction \n ${message}";

  static String m36(serial) =>
      "A request to change the device with serial ${serial} already exists. Do you want to continue?";

  static String m37(number) => "Total number of signatures: (${number})";

  static String m38(total) => "Total: ${total} results";

  static String m39(total) => "(${total} transactions)";

  static String m40(numberCertificate) => "Certificate ${numberCertificate}";

  static String m41(number) => "${number} turn";

  static String m42(version) => "VNPT SmartCA version ${version}";

  static String m43(number) => "${number} VNĐ";
  ...
  static String m45(listExpired, listValid) =>
      "You have ${listExpired} certificates that have expired, ${listValid} certificates that are about to expire.";

  static String m46(listExpired) =>
      "You have ${listExpired} digital certificates that have expired.";

  static String m47(listValid) =>
      "You have ${listValid} digital certificates that are about to expire.";

  final messages = _notInlinedMessages(_notInlinedMessages);
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    "Activated": MessageLookupByLibrary.simpleMessage("Activated"),
    "ConfirmGenCert_Content": MessageLookupByLibrary.simpleMessage(
      "I confirm that the issued Digital Certificate matches the registered information",
    ),
    ...
    "KAKNotFound": MessageLookupByLibrary.simpleMessage(
      "The certificate has not been registered on the device. Do you want to reactivate the digital certificate?",
    ),
    ...
    "acceptanceTranTypeDesc": MessageLookupByLibrary.simpleMessage(
      "Acceptance",
    ),
    "accordingToInstallationTime": MessageLookupByLibrary.simpleMessage(
      "According to installation time",
    ),
    "accordingToUsageNeeds": MessageLookupByLibrary.simpleMessage(
    ...
    "accountRegisteredSuccessfully": MessageLookupByLibrary.simpleMessage(
      "Identifier number has been registered.\nPlease Login to continue!",
    ),
    ...
    "activateButton": MessageLookupByLibrary.simpleMessage(
      "Confirm acceptance minutes",
    ),
    "activateCode": MessageLookupByLibrary.simpleMessage("Activate code"),
    "activateKeyPair": MessageLookupByLibrary.simpleMessage("Activate keypair"),
    "activateOnAnotherDevice": MessageLookupByLibrary.simpleMessage(
      "Activated on Another device",
    ),
    "activateOnThisDevice": MessageLookupByLibrary.simpleMessage(
    ...
    "activateSuccessTitle": MessageLookupByLibrary.simpleMessage(
      "Activate success",
    ),
    ...
    "activateTransactionNotSignKeypair": MessageLookupByLibrary.simpleMessage(
      "The account has not been activated with a key pair",
    ),
    "activated": MessageLookupByLibrary.simpleMessage("Activated"),
    "activationTutorial": MessageLookupByLibrary.simpleMessage(
      "Activation tutorial",
    ),
    ...
    "activingCert": MessageLookupByLibrary.simpleMessage(
      "Activating certificate...",
    ),
    "activingKey": MessageLookupByLibrary.simpleMessage(
      "Please wait a moment...",
    ),
    "addAccount": MessageLookupByLibrary.simpleMessage("Add another account"),
    "addDocument": MessageLookupByLibrary.simpleMessage("Add document"),
    "address": MessageLookupByLibrary.simpleMessage("Address"),
    "addressDetail": MessageLookupByLibrary.simpleMessage("Detailed address"),
    "addressFullLabel": MessageLookupByLibrary.simpleMessage(
      "Province/City, Ward/Commune",
    ),
    "addressInfo": MessageLookupByLibrary.simpleMessage(
      "Certificate Registration Address",
    ),
    "addressInvalid": MessageLookupByLibrary.simpleMessage(
      "Invalid address, please select again",
    ),
    "addressOnDocuments": MessageLookupByLibrary.simpleMessage(
      "Place of Origin",
    ),
    "addressOption": MessageLookupByLibrary.simpleMessage("Address option"),
    "affiliateAppName": MessageLookupByLibrary.simpleMessage("Linked App Name"),
    "affiliateApplication": MessageLookupByLibrary.simpleMessage("Linked app"),
    ...
    "approve_request_er": MessageLookupByLibrary.simpleMessage(
      "Browse error requests",
    ),
    "authentication": MessageLookupByLibrary.simpleMessage("Authentication"),
    "await_approve_cert": MessageLookupByLibrary.simpleMessage(
      "VNPT has received and is processing your request for digital certificate registration.",
    ),
    "back": MessageLookupByLibrary.simpleMessage("Back"),
    "backLighting": MessageLookupByLibrary.simpleMessage("Avoid back lighting"),
    ...
    "bioNotRecognized": MessageLookupByLibrary.simpleMessage(
      "Biometric not recognized!",
    ),
    "bioRequiredTitle": MessageLookupByLibrary.simpleMessage(
      "Biometric required title",
    ),
    "bioSignInTitle": MessageLookupByLibrary.simpleMessage(
    ...
    "biometricDialogButton": MessageLookupByLibrary.simpleMessage(
      "Authentication by biometric",
    ),
    "biometricDialogTitle": MessageLookupByLibrary.simpleMessage(
      "Authentication required",
    ),
    ...
    "biometricsGoToSettingsDesc": MessageLookupByLibrary.simpleMessage(
      "The app hasn\'t been given permission to access biometric features. Please go to your device\'s Settings and enable biometric functionality",
    ),
    "blurryPhotos": MessageLookupByLibrary.simpleMessage(
      "Advoid too blurry photos",
    ),
    ...
    "businessOrganization": MessageLookupByLibrary.simpleMessage(
    ...
    "buySignatures": MessageLookupByLibrary.simpleMessage("Buy\nSignatures"),
    ...
    "callNow": MessageLookupByLibrary.simpleMessage("Call "),
    "canLoading": MessageLookupByLibrary.simpleMessage("Release to load more"),
    "can_giua": MessageLookupByLibrary.simpleMessage("Center"),
    "can_le": MessageLookupByLibrary.simpleMessage("Alignment"),
    "can_not_extend_cert": MessageLookupByLibrary.simpleMessage(
      "You cannot extend!",
    ),
    ...
    "cancelTransaction": MessageLookupByLibrary.simpleMessage(
      "Cancel transaction",
    ),
    "cancelTransactionDone": MessageLookupByLibrary.simpleMessage(
    ...
    "cannotSignKeyChallenge": MessageLookupByLibrary.simpleMessage(
      "Cannot sign key challenge",
    ),
    "cant_not_certificate_active_in_device": MessageLookupByLibrary.simpleMessage(
    ...
    "certDeleteStatus": MessageLookupByLibrary.simpleMessage("Delete"),
    "certDetail": MessageLookupByLibrary.simpleMessage("Certificate details"),
    ...
    "certOvertimeDesc": MessageLookupByLibrary.simpleMessage(
      "You have a certificate with compensated usage time. Please reactivate.",
    ),
    ...
    "certificate_package_get_list_error": MessageLookupByLibrary.simpleMessage(
    ...
    "certificate_package_get_wards_error": MessageLookupByLibrary.simpleMessage(
    ...
    "certificate_package_list_empty": MessageLookupByLibrary.simpleMessage(
      "No data displayed",
    ),
    ...
    "certificate_package_list_option_sign_no_limit":
        MessageLookupByLibrary.simpleMessage("Unlimited number of signatures"),
    "certificate_package_list_title": MessageLookupByLibrary.simpleMessage(
    ...
    "certificate_package_progress_order": MessageLookupByLibrary.simpleMessage(
      "Order processing...",
    ),
    ...
    "certificate_package_register_first": MessageLookupByLibrary.simpleMessage(
      "No account? ",
    ),
    "certificate_package_register_second": MessageLookupByLibrary.simpleMessage(
    ...
    "certificate_package_user_form_info_item_text_group_three":
        MessageLookupByLibrary.simpleMessage("show exactly with the documents"),
    ...
    "certificate_serial": MessageLookupByLibrary.simpleMessage(
      "Serial digital certificate",
    ),
    ...
    "changeDeviceOrder": MessageLookupByLibrary.simpleMessage("Change device"),
    "changeDevicePurpose": MessageLookupByLibrary.simpleMessage(
      "Used in the following cases:\n- The device used to activate the digital certificate is lost\n- Switching to another device for digital signing\n- Forgot or want to change the PIN code\n- Reactivate the digital certificate when an error occurs",
    ),
    ...
    "change_info": MessageLookupByLibrary.simpleMessage("Change information"),
    "checkingInfor": MessageLookupByLibrary.simpleMessage(
      "Please wait a moment...",
    ),
    "chi_hien_thi_logo": MessageLookupByLibrary.simpleMessage(
      "3. Show only the logo",
    ),
    "chi_hien_thi_text": MessageLookupByLibrary.simpleMessage(
      "1. Display only text",
    ),
    "chon_chu_ky": MessageLookupByLibrary.simpleMessage(
      "Touch anywhere to select signature",
    ),
    "chon_tai_lieu": MessageLookupByLibrary.simpleMessage("Select document"),
    "chon_tep": MessageLookupByLibrary.simpleMessage("Select file"),
    "chooseDocumentToSign": MessageLookupByLibrary.simpleMessage(
      "Choose document",
    ),
    "chu_ky_ben_phai_logo_chu_ben_trai": MessageLookupByLibrary.simpleMessage(
      "Signature on the right, logo and text on the left",
    ),
    "chu_ky_ben_trai_logo_chu_ben_phai": MessageLookupByLibrary.simpleMessage(
      "Signature on the left, logo and text on the right",
    ),
    "chu_ky_giua": MessageLookupByLibrary.simpleMessage(
      "Signature in the middle",
    ),
    "chup_anh": MessageLookupByLibrary.simpleMessage("Take a photo"),
    "citizenId": m3,
    "citizenIdFullLabel": MessageLookupByLibrary.simpleMessage("Id/Tax number"),
    "citizenIdLabel": MessageLookupByLibrary.simpleMessage("ID/Tax"),
    "citizenIdentification": MessageLookupByLibrary.simpleMessage(
    ...
    "configSignatureTemplate": MessageLookupByLibrary.simpleMessage(
      "Config Signature template",
    ),
    ...
    "confirmPINDesc": MessageLookupByLibrary.simpleMessage(
    ...
    "contactCustomerCare": MessageLookupByLibrary.simpleMessage(
      "Customer Service Center",
    ),
    "contactHotline": MessageLookupByLibrary.simpleMessage(
    ...
    "createPinTitle": MessageLookupByLibrary.simpleMessage("Create PIN code"),
    ...
    "create_ticket_extension_error_label": MessageLookupByLibrary.simpleMessage(
    ...
    "creatingContract": MessageLookupByLibrary.simpleMessage(
      "Creating a contract",
    ),
    ...
    "ctsOrg": MessageLookupByLibrary.simpleMessage(
      "Enterprise Digital Certificate",
    ),
    "ctsPersonal": MessageLookupByLibrary.simpleMessage(
      "Personal Digital Certificate",
    ),
    "ctsPersonalInOrg": MessageLookupByLibrary.simpleMessage(
      "Personal Digital Certificate belonging to the organization",
    ),
    "currentPassword": MessageLookupByLibrary.simpleMessage("Current password"),
    "currentPasswordNotCorrect": MessageLookupByLibrary.simpleMessage(
      "Current password is not correct",
    ),
    "customer_info": MessageLookupByLibrary.simpleMessage(
      "Customer information",
    ),
    "cycle": MessageLookupByLibrary.simpleMessage("Cycle"),
    "da": MessageLookupByLibrary.simpleMessage("has expired"),
    "danh_sach_chu_ky": MessageLookupByLibrary.simpleMessage(
      "List of signatures",
    ),
    ...
    "deleteLinkSystem": MessageLookupByLibrary.simpleMessage(
      "Delete the link system",
    ),
    ...
    "desc_Electronic_Contract": MessageLookupByLibrary.simpleMessage(
      "Electronic contract for service provision ",
    ),
    "desc_check1_serviceRequestForm": MessageLookupByLibrary.simpleMessage(
      "I have read and agree to the ",
    ),
    "desc_check2_serviceRequestForm": MessageLookupByLibrary.simpleMessage(
      "I have read, understand and agree to check the box and click Continue is the signing ",
    ),
    "descriptionForPIN": MessageLookupByLibrary.simpleMessage(
      "The PIN you created for the digital signature",
    ),
    "detail": MessageLookupByLibrary.simpleMessage("Detail"),
    "detailAddress": MessageLookupByLibrary.simpleMessage("Detail address"),
    "detailDocSignature": MessageLookupByLibrary.simpleMessage(
      "Detail document",
    ),
    "deviceId": MessageLookupByLibrary.simpleMessage("Device\'s ID"),
    "deviceIdloggedIn": MessageLookupByLibrary.simpleMessage(
      "DeviceId being logged in",
    ),
    "deviceUsingThisCert": MessageLookupByLibrary.simpleMessage("Device"),
    "digitalCertificate": MessageLookupByLibrary.simpleMessage(
      "Digital certificate",
    ),
    "digitalSignature": MessageLookupByLibrary.simpleMessage("Sign"),
    "digitalSignatureDocument": MessageLookupByLibrary.simpleMessage("History"),
    "dinh_danh_file_ho_tro": MessageLookupByLibrary.simpleMessage(
      "Supported file formats",
    ),
    "district": MessageLookupByLibrary.simpleMessage("District"),
    "doNotCloseApp": MessageLookupByLibrary.simpleMessage(
      "Please do not close this screen.",
    ),
    "docSignatureHistory": MessageLookupByLibrary.simpleMessage(
    ...
    "drawYourSignature": MessageLookupByLibrary.simpleMessage(
      "Draw your signature",
    ),
    ...
    "ekycFail": MessageLookupByLibrary.simpleMessage("Can not verify via EKYC"),
    "ekycWrong": MessageLookupByLibrary.simpleMessage(
      "Sorry, we were unable to verify your eKYC information.",
    ),
    ...
    "emailReceiveNotification": MessageLookupByLibrary.simpleMessage("Email"),
    ...
    "enoughLength": m6,
    "enterAccountInformation": MessageLookupByLibrary.simpleMessage(
      "Enter account information",
    ),
    "enterActivateCode": MessageLookupByLibrary.simpleMessage(
      "Enter activate code",
    ),
    "enterAnything": m7,
    ...
    "enterTextToSearchOrder": MessageLookupByLibrary.simpleMessage(
      "Enter order code or name",
    ),
    "enterThePackageNameToSearch": MessageLookupByLibrary.simpleMessage(
      "Enter the package name to search",
    ),
    "enterpriseExtendCertMess": MessageLookupByLibrary.simpleMessage(
      "The __ package digital certificate of the customer __ __. Please contact the nearest VNPT for implementation or call 18001260 branch 1 for support.",
    ),
    ...
    "eseal_get_totp_link": MessageLookupByLibrary.simpleMessage(
      "Get TOTP code",
    ),
    ...
    "extendCertDetailNotify1": MessageLookupByLibrary.simpleMessage(
      "Digital certificate is about to expire",
    ),
    "extendCertDetailNotify2": MessageLookupByLibrary.simpleMessage(
      "Digital certificate has expired",
    ),
    "extendNote1": MessageLookupByLibrary.simpleMessage(
      "Customers can make free digital signing transactions on the National Public Service Portal, Ministries, Provinces/Cities and will not be deducted from the number of signatures in the registered package.",
    ),
    "extendNote2": MessageLookupByLibrary.simpleMessage(
      "The number of signatures in the package can only be used while the digital certificate is valid.",
    ),
    ...
    "file_format": MessageLookupByLibrary.simpleMessage(
      "PDF, DOC, XML, PPT, TXT format",
    ),
    "filterByMonth": m10,
    ...
    "forgotPasswordNote": MessageLookupByLibrary.simpleMessage(
      "Forgot password request will be sent:",
    ),
    "forgotPasswordScreen": MessageLookupByLibrary.simpleMessage(
      "Forgot password",
    ),
    ...
    "generateCerKey": MessageLookupByLibrary.simpleMessage(
      "The system is issuing a digital certificate.",
    ),
    "generateCertificateSuccess": MessageLookupByLibrary.simpleMessage(
    ...
    "get_totp_title": MessageLookupByLibrary.simpleMessage(
      "Your enhanced TOTP code is",
    ),
    ...
    "get_totp_undisclosed_code": MessageLookupByLibrary.simpleMessage(
      "DO NOT DISCLOSE TOTP CODE ",
    ),
    ...
    "handlingInstructions": MessageLookupByLibrary.simpleMessage(
    ...
    "haveNotYetTransaction": MessageLookupByLibrary.simpleMessage(
      "Have not yet transaction",
    ),
    ...
    "hideCertHide": MessageLookupByLibrary.simpleMessage(
      "Hide hidden digital certificates",
    ),
    ...
    "identificationCardType": MessageLookupByLibrary.simpleMessage(
      "Identification card type",
    ),
    "identificationNumber": MessageLookupByLibrary.simpleMessage(
      "Identification number",
    ),
    "idleLoading": MessageLookupByLibrary.simpleMessage("Pull up to load more"),
    "ifDeletePleaseMake": m11,
    "importantInfo": MessageLookupByLibrary.simpleMessage(
      "Full name, ID number",
    ),
    "inProgress": MessageLookupByLibrary.simpleMessage("Processing"),
    "included10VAT": MessageLookupByLibrary.simpleMessage("10% VAT included"),
    "individualBusinessHouseholds": MessageLookupByLibrary.simpleMessage(
      "Individual business households",
    ),
    "individualExtendCertMess": MessageLookupByLibrary.simpleMessage(
      "The __ package digital certificate of the customer __ __. Please Renew to continue using the service.",
    ),
    ...
    "informationRegistration": MessageLookupByLibrary.simpleMessage(
      "Information registration",
    ),
    "information_buy_packages": MessageLookupByLibrary.simpleMessage(
      "Order package infomation",
    ),
    ...
    "initializingKeyPair": MessageLookupByLibrary.simpleMessage(
      "Initializing key pair",
    ),
    "initializingKeyPairDescription": MessageLookupByLibrary.simpleMessage(
      "The system is initializing the key pair.\nPlease wait a moment...",
    ),
    "initializingTheService": MessageLookupByLibrary.simpleMessage(
      "Initializing the service",
    ),
    "inputNameDoc": MessageLookupByLibrary.simpleMessage("Enter document name"),
    "inputOTP": MessageLookupByLibrary.simpleMessage(
      "Enter authentication code",
    ),
    "inputOTPVerify": MessageLookupByLibrary.simpleMessage(
      "Enter OTP for authentication",
    ),
    "inputReferralCode": MessageLookupByLibrary.simpleMessage(
      "Type referral code",
    ),
    "inputRequired": m12,
    ...
    "invalidParameter": MessageLookupByLibrary.simpleMessage(
      "Invalid Parameter.",
    ),
    ...
    "listFileEmpty": MessageLookupByLibrary.simpleMessage(
      "Have no file to preview",
    ),
    ...
    "listPacks": m13,
    "listTransactions": MessageLookupByLibrary.simpleMessage(
    ...
    "makePaymentAgain": MessageLookupByLibrary.simpleMessage(
      "Make payment again",
    ),
    ...
    "minLength": m15,
    "missingCorner": MessageLookupByLibrary.simpleMessage(
      "Advoid take missing-conrner",
    ),
    "money": MessageLookupByLibrary.simpleMessage("Money"),
    "month_text": MessageLookupByLibrary.simpleMessage("Month"),
    "msgAccountActived": m16,
    "msgAccountNotFound": m17,
    ...
    "nameContact": MessageLookupByLibrary.simpleMessage(
      "Contact person\'s name",
    ),
    "nameDoc": MessageLookupByLibrary.simpleMessage("Document name"),
    "nameFor": MessageLookupByLibrary.simpleMessage("Name for"),
    "nameForCTS": MessageLookupByLibrary.simpleMessage("Rename certificate"),
    "nationality": MessageLookupByLibrary.simpleMessage("Nationality"),
    "newCertOrder": MessageLookupByLibrary.simpleMessage(
      "Buy digital certificate",
    ),
    ...
    "newOrExtend": MessageLookupByLibrary.simpleMessage(
      "Please Purchase/Renew/Active Certificate to continue.",
    ),
    "newPassIsEmpty": MessageLookupByLibrary.simpleMessage(
      "Field new password is not empty",
    ),
    "newPassword": MessageLookupByLibrary.simpleMessage("New password"),
    "newRegistration": MessageLookupByLibrary.simpleMessage("New Registration"),
    "next": MessageLookupByLibrary.simpleMessage("Next"),
    "nextAssignKey": MessageLookupByLibrary.simpleMessage(
      "Next step: Activate keypair",
    ),
    "nextSignBbnt": MessageLookupByLibrary.simpleMessage(
      "Next step: Confirm acceptance minutes",
    ),
    "nextStepPin": MessageLookupByLibrary.simpleMessage(
      "Next step: Create PIN",
    ),
    "nha_noi_dung_chu_ky": MessageLookupByLibrary.simpleMessage(
      "Enter content",
    ),
    ...
    "noticeOfInvoice": MessageLookupByLibrary.simpleMessage(
      "Notice of Invoice",
    ),
    "noticeWhenPasswordChange": MessageLookupByLibrary.simpleMessage(
      "Your password has changed. Please login again.",
    ),
    "notice_cert_action_for_business_account": m19,
    "notice_create_transaction": MessageLookupByLibrary.simpleMessage(
      "Note: Selecting a signature template is only for PDF files!",
    ),
    ...
    "notice_type_password": MessageLookupByLibrary.simpleMessage(
      "Note: Password must be 8-12 characters. Include uppercase, lowercase, numbers and special characters @,#,\$,&,*,!. \nDo not include consecutive or duplicate numbers, proper names and unit names.",
    ),
    ...
    "notify_extend_personal_sign_success": MessageLookupByLibrary.simpleMessage(
      "Initialization service package successful!",
    ),
    "numberActionNotComplete": m20,
    "numberContractNotComplete": m21,
    "numberEKYCNotComplete": m22,
    "numberOfSignatures": MessageLookupByLibrary.simpleMessage(
      "Number of signatures",
    ),
    "numberOfUnusedTurns": MessageLookupByLibrary.simpleMessage(
      "Number of Unused Turns",
    ),
    "numberPaymentNotComplete": m23,
    "numberRegisterNotComplete": m24,
    "numberWaitingActiveCer": m25,
    "numberWaitingOrder": m26,
    "of_VNPT": MessageLookupByLibrary.simpleMessage("of VNPT"),
    "oldPassIsEmpty": MessageLookupByLibrary.simpleMessage(
      "Field old password is not empty",
    ),
    "oldPassword": MessageLookupByLibrary.simpleMessage("Old password"),
    "oldPasswordWrong": MessageLookupByLibrary.simpleMessage(
      "Wrong old password",
    ),
    "oneWaitingOrder": MessageLookupByLibrary.simpleMessage(
      "There is 1 order waiting to be handle!",
    ),
    "openVNPTSmartApp": MessageLookupByLibrary.simpleMessage(
      "Open VNPT SmartCA App",
    ),
    ...
    "orderAPPROVE_REQUEST_CERT_WAITING": MessageLookupByLibrary.simpleMessage(
      "Waiting for digital certificate approval",
    ),
    "orderCANCELED": MessageLookupByLibrary.simpleMessage("Cancelled"),
    "orderCANCEL_ERROR": MessageLookupByLibrary.simpleMessage("Cancel failed"),
    ...
    "orderCanceling": MessageLookupByLibrary.simpleMessage("Canceling"),
    ...
    "orderPAYMENT_ERROR": MessageLookupByLibrary.simpleMessage(
      "Payment failed",
    ),
    "orderPAYMENT_WAITING": MessageLookupByLibrary.simpleMessage(
      "Waiting for online payment",
    ),
    "orderREJECT_REQUEST_CERT": MessageLookupByLibrary.simpleMessage(
      "Deny request",
    ),
    ...
    "order_history_page_title": MessageLookupByLibrary.simpleMessage(
      "Order history",
    ),
    "order_new": MessageLookupByLibrary.simpleMessage(
      "Wait for initialization",
    ),
    "order_paid": MessageLookupByLibrary.simpleMessage(
      "Wait for initialization",
    ),
    ...
    "package_information": MessageLookupByLibrary.simpleMessage(
      "Package information",
    ),
    "page_servive_pack_order_desc": MessageLookupByLibrary.simpleMessage(
      "You have successfully purchased the service package.",
    ),
    "page_servive_pack_order_title": MessageLookupByLibrary.simpleMessage(
      "Payment orders",
    ),
    ...
    "phoneContact": MessageLookupByLibrary.simpleMessage(
    ...
    "pinDialogConfirmSignDigitalTitle": MessageLookupByLibrary.simpleMessage(
    ...
    "pinValidateNotMatch": MessageLookupByLibrary.simpleMessage(
    ...
    "pleaseAddYourSignature": MessageLookupByLibrary.simpleMessage(
      "Please add your signature",
    ),
    "pleaseCheckForgotPassword": m27,
    "pleaseCheckTheCorrectInformation": MessageLookupByLibrary.simpleMessage(
    ...
    "pleaseChooseStartDate": MessageLookupByLibrary.simpleMessage(
    ...
    "please_input_full_name": MessageLookupByLibrary.simpleMessage(
      "Please enter full name.",
    ),
    "policyTitle": MessageLookupByLibrary.simpleMessage(
      "Personal data\nprotection policy",
    ),
    "positionInOrg": MessageLookupByLibrary.simpleMessage("Position"),
    ...
    "ps0_package_fee_content": MessageLookupByLibrary.simpleMessage("Free"),
    "ps0_package_fee_label": MessageLookupByLibrary.simpleMessage(
      "Service fee",
    ),
    "ps0_package_name": MessageLookupByLibrary.simpleMessage(
      "SmartCA personal PS0 (Citizen)",
    ),
    "ps0_package_note": MessageLookupByLibrary.simpleMessage(
      "You can sign for free on MyVNPT and Public Service Portal",
    ),
    "ps0_package_time_content": MessageLookupByLibrary.simpleMessage(
      "12 months",
    ),
    "ps0_package_time_label": MessageLookupByLibrary.simpleMessage(
      "Usage time",
    ),
    "qrCodeInvalid": MessageLookupByLibrary.simpleMessage("QR Code invalid"),
    "qrCodeInvalidDescription": MessageLookupByLibrary.simpleMessage(
      "Please use QR code on Citizen ID to get information!",
    ),
    "qrCodeIsRegistered": m28,
    "qrCodeIsWaitingActive": m29,
    ...
    "reSignAcceptance": MessageLookupByLibrary.simpleMessage(
      "Signing the Acceptance was unsuccessful. Please click continue to re-sign.",
    ),
    "reSignAcceptanceSuccess": MessageLookupByLibrary.simpleMessage(
      "Sign the Acceptance was successful. To continue using the service, please activate digital certificate.",
    ),
    "re_create_service_order": MessageLookupByLibrary.simpleMessage(
      "Re initialize service package",
    ),
    "reactivateAccount": MessageLookupByLibrary.simpleMessage(
      "Reactivate account?",
    ),
    "reactivateCert": MessageLookupByLibrary.simpleMessage(
      "Reactivate Digital Cert",
    ),
    ...
    "registerAccountContactHotline": m30,
    ...
    "registerServiceSuccessGuideNextStep": m31,
    "registrationCardType": MessageLookupByLibrary.simpleMessage(
      "Registration card type",
    ),
    "reject": MessageLookupByLibrary.simpleMessage("Reject"),
    "remainTimeToSign": MessageLookupByLibrary.simpleMessage(
      "Remain time to sign",
    ),
    ...
    "renewCertOrder": MessageLookupByLibrary.simpleMessage(
    ...
    "requestBiometricDesc": m32,
    "requestLinkSuccess": MessageLookupByLibrary.simpleMessage(
      "The request to link was successful",
    ),
    "requestOrderType": MessageLookupByLibrary.simpleMessage("Request type"),
    ...
    "resendOTPLater": MessageLookupByLibrary.simpleMessage(
      "Resend the otp code later",
    ),
    ...
    "sap": MessageLookupByLibrary.simpleMessage("is about to expire"),
    ...
    "searchAdvance": MessageLookupByLibrary.simpleMessage("Advanced search"),
    ...
    "selectCertificate": MessageLookupByLibrary.simpleMessage(
      "Select certificate",
    ),
    "selectCertificatePack": MessageLookupByLibrary.simpleMessage(
      "Select certificate package",
    ),
    ...
    "select_time_to_extend": MessageLookupByLibrary.simpleMessage(
      "Select renewal period",
    ),
    "send": MessageLookupByLibrary.simpleMessage("Send"),
    "sendSupportRequest": MessageLookupByLibrary.simpleMessage(
    ...
    "serviceGeneratingKAK": MessageLookupByLibrary.simpleMessage(
      "Creating KAK",
    ),
    "serviceInitialization": MessageLookupByLibrary.simpleMessage(
    ...
    "serviceNoAccessTokenFound": MessageLookupByLibrary.simpleMessage(
    ...
    "serviceNotFoundDevice": MessageLookupByLibrary.simpleMessage(
      "No device found",
    ),
    "serviceNotFoundFCMToken": MessageLookupByLibrary.simpleMessage(
      "Cannot register to receive notify",
    ),
    "serviceRejectFail": MessageLookupByLibrary.simpleMessage("Reject failed"),
    ...
    "serviceVerifyAppFail": MessageLookupByLibrary.simpleMessage(
      "Verify fail app",
    ),
    "service_pack_create_order_failed": MessageLookupByLibrary.simpleMessage(
      "Error: Order failed.",
    ),
    "service_pack_get_failed": MessageLookupByLibrary.simpleMessage(
      "Error: Failed to get sign package information.",
    ),
    "service_pack_order_status": MessageLookupByLibrary.simpleMessage(
      "Status:",
    ),
    ...
    "service_pack_signatures": MessageLookupByLibrary.simpleMessage(
      "Signatures",
    ),
    "service_pack_total_amount": MessageLookupByLibrary.simpleMessage("Total"),
    "service_pack_total_signature": MessageLookupByLibrary.simpleMessage(
      "Total signatures:",
    ),
    "service_pack_vat_included": MessageLookupByLibrary.simpleMessage(
      "(Included 10% VAT)",
    ),
    ...
    "setup_smart_ca_password": MessageLookupByLibrary.simpleMessage(
      "Set up SmartCA account password",
    ),
    ...
    "showCTSInListScreen": MessageLookupByLibrary.simpleMessage(
      "Show this certificate on list",
    ),
    "sign": MessageLookupByLibrary.simpleMessage("Sign all"),
    "sign769TranTypeDesc": MessageLookupByLibrary.simpleMessage(
      "Sign hash 769",
    ),
    "signBbnt": MessageLookupByLibrary.simpleMessage(
      "Confirm acceptance minutes",
    ),
    "signBbntSuccess": MessageLookupByLibrary.simpleMessage(
      "Sign acceptance minutes successful. You can now confirm transactions at the Sign tab.",
    ),
    "signChangeRequest": MessageLookupByLibrary.simpleMessage(
      "Sign the change request form",
    ),
    "signConfirm": MessageLookupByLibrary.simpleMessage("Sign confirmation"),
    ...
    "signTheProposalForm": MessageLookupByLibrary.simpleMessage(
      "Sign the proposal",
    ),
    "signToQD769": MessageLookupByLibrary.simpleMessage("Sign to QD-769-BTTTT"),
    "signTranTypeDesc": MessageLookupByLibrary.simpleMessage(
      "Document Signing",
    ),
    "signTransactionDone": MessageLookupByLibrary.simpleMessage(
      "Your transaction has been signed successfully",
    ),
    "sign_ticket_extension_title": MessageLookupByLibrary.simpleMessage(
      "Sign extension request form",
    ),
    "sign_tranaction_success": m35,
    "signatureOption": MessageLookupByLibrary.simpleMessage("Signature option"),
    ...
    "signingInformation": MessageLookupByLibrary.simpleMessage(
      "Signing Information",
    ),
    "size": MessageLookupByLibrary.simpleMessage("Size"),
    "startVerifying": MessageLookupByLibrary.simpleMessage("Start Verifying"),
    ...
    "strongPasswordValid": MessageLookupByLibrary.simpleMessage(
      "- Use 8-30 characters including uppercase, lowercase, numbers, special characters ~!@#\$%^&*_-+=`|(){}[]:;”<>,.? /\n- Does not include identical or consecutive numbers such as 1111, 12345, 9876, ...\n- Does not include words related to personal information or unit abbreviations such as: VNPT, Admin, Root, Quantri, ...",
    ),
    "subDesc_check1_serviceRequestForm": MessageLookupByLibrary.simpleMessage(
      "Terms of Service, Personal data protection policy of VNPT",
    ),
    "subject": MessageLookupByLibrary.simpleMessage("Subject"),
    "submit_onebss_er": MessageLookupByLibrary.simpleMessage(
      "Submit a request to OneBSS error",
    ),
    "subscriber_information": MessageLookupByLibrary.simpleMessage(
      "Subscriber information",
    ),
    "subscriber_name": MessageLookupByLibrary.simpleMessage("Subscriber name"),
    ...
    "suggested_extension": MessageLookupByLibrary.simpleMessage(
      "Suggested extension",
    ),
    ...
    "sync_onebss_er": MessageLookupByLibrary.simpleMessage(
      "Syncing profile to OneBSS error",
    ),
    ...
    "tai_hinh_nen": MessageLookupByLibrary.simpleMessage(
      "Upload image background",
    ),
    "tai_mau_dinh_kem": MessageLookupByLibrary.simpleMessage(
      "Upload attached sample",
    ),
    "takePhotoBrightClear": MessageLookupByLibrary.simpleMessage(
      "Take photos that are bright and clear",
    ),
    "tao_yeu_cau_chungthu_loi": MessageLookupByLibrary.simpleMessage(
      "Generate certificate request error",
    ),
    "taxCode": MessageLookupByLibrary.simpleMessage("Tax code"),
    "ten_chung_thu": MessageLookupByLibrary.simpleMessage("Certificate name"),
    "termOfUseService": MessageLookupByLibrary.simpleMessage(
      "terms of service",
    ),
    ...
    "them_mau_chu_ky": MessageLookupByLibrary.simpleMessage(
      "Add signature template",
    ),
    "thereIsDeviceChangeRequest": m36,
    "time": MessageLookupByLibrary.simpleMessage("Time"),
    "timeExtensionDescription": MessageLookupByLibrary.simpleMessage(
      "Select the digital certificate to time extension",
    ),
    "timeExtensionNote": MessageLookupByLibrary.simpleMessage(
      "The old digital certificate will be suspended and cannot be restored after the time extension is completed",
    ),
    "timeToDate": MessageLookupByLibrary.simpleMessage("Time to date"),
    "titleCertInfo": MessageLookupByLibrary.simpleMessage(
      "Digital Certificate Information",
    ),
    "toDate": MessageLookupByLibrary.simpleMessage("To Date"),
    "toPerformSystemLinking": MessageLookupByLibrary.simpleMessage(
      " to perform system linking",
    ),
    "to_chu_xac_thuc": MessageLookupByLibrary.simpleMessage(
      "Authorization organization",
    ),
    "tokenExpired": MessageLookupByLibrary.simpleMessage("Token expired"),
    "totalNumberSignatures": m37,
    "totalRecord": m38,
    "totalResult": m39,
    ...
    "transactionDesc": MessageLookupByLibrary.simpleMessage(
    ...
    "transactionNotWaiting": MessageLookupByLibrary.simpleMessage(
      "Transaction completed Sign/Cancel",
    ),
    "transactionStatus": MessageLookupByLibrary.simpleMessage(
      "Transaction status",
    ),
    "transactionType": MessageLookupByLibrary.simpleMessage("Transaction type"),
    "transaction_request_group_title": m40,
    ...
    "tutorialRegisterAccount": MessageLookupByLibrary.simpleMessage(
      "Register account tutorial",
    ),
    "tuy_chon_vi_tri_ky": MessageLookupByLibrary.simpleMessage(
      "Signature Location Options",
    ),
    "typeOfCertificate": MessageLookupByLibrary.simpleMessage(
      "Type of certificate",
    ),
    "unitInOrg": MessageLookupByLibrary.simpleMessage("Unit"),
    "unknown": MessageLookupByLibrary.simpleMessage("Unknown"),
    "unlimitedNumberOfSignatures": MessageLookupByLibrary.simpleMessage(
      "Unlimited number of signatures",
    ),
    "unuseds_ignatures": MessageLookupByLibrary.simpleMessage(
      "Unused signatures",
    ),
    "update": MessageLookupByLibrary.simpleMessage("Update"),
    "updateAddressNotice": MessageLookupByLibrary.simpleMessage(
      "Please update your registered address according to the Regulations on merging Provinces and Communes under the Law on Local Government Organization 2025 and Resolution 1211/2016/UBTVQH13",
    ),
    "updateHistory": MessageLookupByLibrary.simpleMessage("Update History"),
    "updateVersionMsg": MessageLookupByLibrary.simpleMessage(
      "Update this app to",
    ),
    ...
    "update_info_title": MessageLookupByLibrary.simpleMessage("Update address"),
    "useTheAddress": MessageLookupByLibrary.simpleMessage(
      "Use the address where you live or work for the fastest support",
    ),
    "use_bio": MessageLookupByLibrary.simpleMessage("Use biometric"),
    ...
    "ve_chu_ky_tai_day": MessageLookupByLibrary.simpleMessage(
      "Draw signature here",
    ),
    "verificationCode": MessageLookupByLibrary.simpleMessage(
      "Verification code",
    ),
    "verifyFail": MessageLookupByLibrary.simpleMessage(
      "Authentication failed!",
    ),
    "verifyFailDetail": MessageLookupByLibrary.simpleMessage(
      "An error occurred, please try again later!",
    ),
    "verifyInfo": MessageLookupByLibrary.simpleMessage("Verify information"),
    ...
    "verifyInfoErrorCauseContent": MessageLookupByLibrary.simpleMessage(
      "Portrait is not real!",
    ),
    "verifyInfoErrorCauseContent2": MessageLookupByLibrary.simpleMessage(
      "Face does not match",
    ),
    "verifyInfoErrorCauseGuide": MessageLookupByLibrary.simpleMessage(
      "You only have a maximum of 03 eKYC executions.",
    ),
    "verifyInfoErrorCauseLabel": MessageLookupByLibrary.simpleMessage(
      "Reason:",
    ),
    ...
    "viewFileHash": MessageLookupByLibrary.simpleMessage(
      "Unable to view encrypted digital document",
    ),
    "viewMore": MessageLookupByLibrary.simpleMessage("View more"),
    "viewMoreCertHide": MessageLookupByLibrary.simpleMessage(
      "View more hidden digital certificates",
    ),
    "viewOrderDetail": MessageLookupByLibrary.simpleMessage("Order detail"),
    "viewTransactionInfo": MessageLookupByLibrary.simpleMessage(
      "View information",
    ),
    "view_detail": MessageLookupByLibrary.simpleMessage("View detail"),
    "vnd": m43,
    "waitaMinute": MessageLookupByLibrary.simpleMessage(
      "Please wait a moment...",
    ),
    "waitingActivate": MessageLookupByLibrary.simpleMessage("Waiting activate"),
    "waitingApprove": MessageLookupByLibrary.simpleMessage(
    ...
    "waitingConfirmBySmartCAApp": MessageLookupByLibrary.simpleMessage(
      "Waiting for transaction confirmation",
    ),
    "waitingConfirmBySmartCAAppSubtitle": MessageLookupByLibrary.simpleMessage(
      "Or open the VNPT SmartCA application on the device that has activated the certificate and Confirm the transaction.",
    ),
    ...
    "waitingForAcceptChangeDeviceTitle": MessageLookupByLibrary.simpleMessage(
    ...
    "waitingForActivation": MessageLookupByLibrary.simpleMessage(
    ...
    "waitingForSignerConfirm": MessageLookupByLibrary.simpleMessage(
      "Wait for confirm",
    ),
    "waitingGenerateCertificate": MessageLookupByLibrary.simpleMessage(
      "Waiting generate certificate",
    ),
    "waitingGenerateKeyPair": MessageLookupByLibrary.simpleMessage(
      "Waiting generate keypair",
    ),
    "waitingProviderCert": MessageLookupByLibrary.simpleMessage(
      "Your profile is being approved. The results will be notified via email. Please come back later!",
    ),
    "waitingSignAcceptanceMinutes": MessageLookupByLibrary.simpleMessage(
      "Waiting confirm acceptance minutes",
    ),
    "waitingSyncBBNT": MessageLookupByLibrary.simpleMessage(
      "Experience Record Synchronization Flag",
    ),
    "waitingUserActive": MessageLookupByLibrary.simpleMessage(
      "Waiting for user activation",
    ),
    "wards": MessageLookupByLibrary.simpleMessage("Wards"),
    "warning": MessageLookupByLibrary.simpleMessage("Warning"),
    "warning_number_sign": m44,
    "whatYouNeedTKnow": MessageLookupByLibrary.simpleMessage(
    ...
    "you_need_know": MessageLookupByLibrary.simpleMessage("You need to know"),
    "yourCertExpiredAndValidNeedExtend": m45,
    "yourCertExpiredNeedExtend": m46,
    "yourCertNeedExtend": MessageLookupByLibrary.simpleMessage(
      "Your digital certificate is about to expire",
    ),
    "yourCertValidNeedExtend": m47,
    "your_cert_package": MessageLookupByLibrary.simpleMessage(
      "Your digital certificate package",
    ),
  };
}
